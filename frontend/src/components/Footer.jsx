...
const FooterLink = ({ children, href, icon: Icon }) => (
  ...
  >
    {Icon && (
      <Icon className="text-electric-blue group-hover:text-vibrant-magenta transition-colors" />
    )}
    {children}
  </motion.a>
);
...
const SocialIcon = ({ Icon, href, label }) => {
  ...
  return (
    ...
    >
      <Icon
        className="text-3xl text-golden-yellow hover:text-vibrant-magenta 
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-6xl grid md:grid-cols-4 gap-8 relative z-10">
        ...
        {/* Quick Links */}
        <motion.div variants={itemVariants} className="md:col-span-1">
          <h3 className="text-xl font-semibold mb-4 text-golden-yellow">
            Explore
          </h3>
        ...
        {/* Contact Information */}
        <motion.div variants={itemVariants} className="md:col-span-1">
          <h3 className="text-xl font-semibold mb-4 text-golden-yellow font-secondary">
            Connect
          </h3>
          <div className="space-y-3 font-happiness">
            <FooterLink href="mailto:sharmaslov@gmail.com" icon={FaEnvelope}>
              sharmaslov@gmail.com
            </FooterLink>
            <FooterLink href="tel:+919828477222" icon={FaPhoneAlt}>
              +91 9828477222
            </FooterLink>
          </div>
        </motion.div>
